    ...
    <div className="px-10 py-12 flex flex-col gap-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          Vous entendrez des conversations entre deux ou plusieurs personnes.
          Vous devrez répondre à{" "}
          <span className="font-semibold">3 questions</span> par conversation.
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          La conversation ne sera énoncée{" "}
          <span className="font-semibold">qu&apos;une seule fois</span>. Les
          questions et les réponses sont visibles à l&apos;écran. Une nouvelle
          conversation s&apos;affiche automatiquement après le délai de réponse.
        </p>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-gray-400">
          {inExam
            ...
            : "L'audio démarre automatiquement à chaque conversation."}
        </p>
      </div>
    </div>
  );
